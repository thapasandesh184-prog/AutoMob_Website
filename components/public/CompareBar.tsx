          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            ...
            <div className="flex-1 flex items-center gap-3 overflow-x-auto w-full sm:w-auto pb-2 sm:pb-0">
              {vehicles.map((vehicle) => (
                <div
                  key={vehicle.id}
                  className="flex items-center gap-3 bg-black/40 border border-white/10 pl-2 pr-3 py-2 flex-shrink-0"
                >
            ...
            <div className="flex items-center gap-3 w-full sm:w-auto">
              ...
              <Link href="/compare" className="flex-1 sm:flex-initial">
                <Button
                  size="sm"
                  className="w-full bg-[#C0A66A] text-black font-medium hover:bg-[#D4BC86]"
                >
                  Compare
                </Button>
              </Link>
