...
export default function Directions() {
  ...
  const mapEmbedUrl = settings.mapEmbedUrl && settings.mapEmbedUrl.trim().startsWith('https://www.google.com/maps/embed')
      ...
      <section className="relative h-[40vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <div
            ...
            style={{ backgroundImage: "url('https://images.unsplash.com/photo-1449824913935-59a10b8d2000?w=1600&q=80')" }}
          />
